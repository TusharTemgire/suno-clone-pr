...
const MobileAppSection = () => {
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex items-center justify-center bg-background-primary">
      ...
      <div className="container relative z-20 flex flex-col items-center justify-center w-full">
        <div className="mx-auto max-w-[800px] text-center">
          <h1 className="text-9xl font-medium leading-11 tracking-[-0.96px] text-white md:leading-24 md:tracking-[-1.44px]">
            The #1 AI<br /> music app
          </h1>
          <h2 className="mt-9 text-base font-light leading-6 text-white/80 md:text-lg">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 w-full max-w-[700px]">
          <div className="flex flex-col items-start rounded-2xl border border-white/15 bg-black/10 p-8 text-left backdrop-blur-[1px] relative">
